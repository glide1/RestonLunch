            ...
            <div class="well sidebar-nav">
                <ul class="nav nav-list">
                  ...
                  <#list restaurants as rest>
                      <li <#if rest.name == restaurant.name>class="active"</#if>><a href="${rc.contextPath}/restaurants/details/${rest.name}.html ">${rest.name}</a></li>
                  </#list>
                </ul>
            </div>
        </div>
        <div class="span9" ng-app>
            <div class="hero-unit" ng-controller="RestaurantVoteCtrl" ng-init="init('${restaurant.name}', '${rc.contextPath}')">
